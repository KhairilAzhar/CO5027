<%@ Page Title="" Language="C#" MasterPageFile="~/Booking.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="Booking.Contact" %>
            ...
            <div id="mail">
                <form id="mailform" action="mailto:info@theempirehotel.com" method="GET">
                   <fieldset>
                    ...
                    <textarea id="message" type="text" name="message" placeholder="Your message..."></textarea><br><br>
